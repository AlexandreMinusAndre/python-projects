...
#Les lignes 9, 10, et 11, servent à interchanger les valeurs des variables grâce à une variable temporaire (tmp) qui contiendra temporairement la valeur de x
tmp = x
x = y
y = tmp
